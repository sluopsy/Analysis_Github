...
#eff_size(controlframe_lowvshi_bio, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
compare_bio <- contrast(controlframe_lowvshi_bio, method = list("Effect of DN (Low - High Bio)" = dn_vs_c_lowbio - dn_vs_c_hibio, 
                                                                ...
                                                                "Effect of MN (Low - High Bio)" = mn_vs_c_lowbio - mn_vs_c_hibio), adjust = "sidak")
...
# effect sizes
eff_size(compare_bio, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
# effect sizes
#eff_size(proenvframe_lowvshi_bio, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
#eff_size(controlframe_lowvshi_alt, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
compare_alt <- contrast(controlframe_lowvshi_alt, method = list("Effect of DN (Low - High alt)" = dn_vs_c_LowAlt - dn_vs_c_HiAlt, 
                                                                ...
                                                                "Effect of MN (Low - High alt)" = mn_vs_c_LowAlt - mn_vs_c_HiAlt), adjust = "sidak")
...
# effect sizes
eff_size(compare_alt, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
# effect sizes
#eff_size(proenvframe_lowvshi_alt, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
#eff_size(controlframe_lowvshi_ego, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
compare_ego <- contrast(controlframe_lowvshi_ego, method = list("Effect of DN (Low - High ego)" = dn_vs_c_LowEgo - dn_vs_c_HiEgo, 
                                                                ...
                                                                "Effect of MN (Low - High ego)" = mn_vs_c_LowEgo - mn_vs_c_HiEgo), adjust = "sidak")
...
# effect sizes
eff_size(compare_ego, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
# effect sizes
#eff_size(proenvframe_lowvshi_ego, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
#eff_size(controlframe_lowvshi_hed, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
compare_hed <- contrast(controlframe_lowvshi_hed, method = list("Effect of DN (Low - High hed)" = dn_vs_c_LowHed - dn_vs_c_HiHed, 
                                                                ...
                                                                "Effect of MN (Low - High hed)" = mn_vs_c_LowHed - mn_vs_c_HiHed), adjust = "sidak")
...
# effect sizes
eff_size(compare_hed, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
# effect sizes
#eff_size(proenvframe_lowvshi_hed, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
#eff_size(controlframe_lowvshi_ing, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
# effect sizes
eff_size(compare_ing, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
# effect sizes
#eff_size(proenvframe_lowvshi_ing, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
# effect sizes
eff_size(norm_compare_ing, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
```{r}
bio_norm_slopes <- emtrends(mod_mice, pairwise~norm_condition, var = "biospheric_center", adjust = "tukey")
...
```{r}
bio_frame_trends <- emtrends(mod_mice, pairwise~framing_condition, var = "biospheric_center", adjust = "tukey")
...
```{r}
bio_frame_norm_trends <- emtrends(mod_mice, pairwise~norm_condition | framing_condition, var = "biospheric_center", adjust = "tukey")
...
```{r}
alt_norm_slopes <- emtrends(mod_mice, pairwise~norm_condition, var = "altruistic_center", adjust = "tukey")
...
```{r}
alt_frame_trends <- emtrends(mod_mice, pairwise~framing_condition, var = "altruistic_center", adjust = "tukey")
...
```{r}
alt_frame_norm_trends <- emtrends(mod_mice, pairwise~norm_condition | framing_condition, var = "altruistic_center", adjust = "tukey")
...
```{r}
ego_norm_slopes <- emtrends(mod_mice, pairwise~norm_condition, var = "egoistic_center", adjust = "tukey")
...
```{r}
ego_frame_trends <- emtrends(mod_mice, pairwise~framing_condition, var = "egoistic_center", adjust = "tukey")
...
```{r}
ego_frame_norm_trends <- emtrends(mod_mice, pairwise~norm_condition | framing_condition, var = "egoistic_center", adjust = "tukey")
...
```{r}
hed_norm_slopes <- emtrends(mod_mice, pairwise~norm_condition, var = "hedonic_center", adjust = "tukey")
...
```{r}
hed_frame_trends <- emtrends(mod_mice, pairwise~framing_condition, var = "hedonic_center", adjust = "tukey")
...
```{r}
hed_frame_norm_trends <- emtrends(mod_mice, pairwise~norm_condition | framing_condition, var = "hedonic_center", adjust = "tukey")
...
```{r}
ing_norm_slopes <- emtrends(mod_mice, pairwise~norm_condition, var = "ingroup_center", adjust = "tukey")
...
```{r}
ing_frame_trends <- emtrends(mod_mice, pairwise~framing_condition, var = "ingroup_center", adjust = "tukey")
...
```{r}
ing_frame_norm_trends <- emtrends(mod_mice, pairwise~norm_condition | framing_condition, var = "ingroup_center", adjust = "tukey")
