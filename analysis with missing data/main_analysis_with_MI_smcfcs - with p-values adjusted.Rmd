...
framing_comparisons <- contrast(frame_emmeans, 
                          method = list("SE Frame - Control Frame" = SE_F_EMM - C_F_EMM,
                                        ...
                                        "PE Frame - Control" = PE_F_EMM - C_F_EMM), adjust = "sidak")
...
eff_size(frame_emmeans, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
# effect sizes
eff_size(frame_means2, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
# effect sizes
eff_size(norm_emmeans, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
# effect sizes
eff_size(cell_emmeans, sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
FxN_pairwise <- contrast(FxN_comparisons, method = list("SE vs Control: DN - Control" = s_DN_vs_C - control_DN_vs_C,
                                                        ...
                                                        "PE vs Control: MN - Control" = p_MN_vs_C - control_MN_vs_C), adjust = "sidak")
