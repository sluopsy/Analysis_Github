...
```{r}
bio_norm_means <- emtrends(full_model_1a, ~norm_condition, var = "biospheric_center", adjust = "none")
...
```{r}
bio_norm_slopes <- emtrends(full_model_1a, pairwise~norm_condition, var = "biospheric_center", adjust = "none")
...
```{r}
bio_frame_slopes <- emtrends(full_model_1a, ~framing_condition, var = "biospheric_center", adjust = "none")
...
```{r}
bio_frame_trends <- emtrends(full_model_1a, pairwise~framing_condition, var = "biospheric_center", adjust = "none")
...
```{r}
bio_frame_norm_trends <- emtrends(full_model_1a, pairwise~norm_condition | framing_condition, var = "biospheric_center", adjust = "none")
...
```{r}
alt_norm_trends <- emtrends(full_model_1a, pairwise~norm_condition, var = "altruistic_center", adjust = "none")
...
```{r}
alt_frame_trends <- emtrends(full_model_1a, pairwise~framing_condition, var = "altruistic_center", adjust = "none")
...
```{r}
ego_norm_trends <- emtrends(full_model_1a, pairwise~norm_condition, var = "egoistic_center", adjust = "none")
...
```{r}
ego_frame_trends <- emtrends(full_model_1a, pairwise~framing_condition, var = "egoistic_center", adjust = "none")
...
```{r}
hed_norm_trends <- emtrends(full_model_1a, pairwise~norm_condition, var = "hedonic_center", adjust = "none")
...
```{r}
hed_frame_trends <- emtrends(full_model_1a, pairwise~framing_condition, var = "hedonic_center", adjust = "none")
...
```{r}
emtrends(full_model_1a, ~norm_condition, var = "ingroup_center", adjust = "none") %>%
  knitr::kable(digits = 2)
```
...
```{r}
ing_norm_trends <- emtrends(full_model_1a, pairwise~norm_condition, var = "ingroup_center", adjust = "none")
...
```{r}
emtrends(full_model_1a, ~framing_condition, var = "ingroup_center", adjust = "none") %>%
  knitr::kable(digits = 2)
```
...
```{r}
ing_frame_trends <- emtrends(full_model_1a, pairwise~framing_condition, var = "ingroup_center", adjust = "none")
...
```{r}
emtrends(full_model_1a, ~norm_condition | framing_condition, var = "ingroup_center", adjust = "none") %>%
  knitr::kable(digits = 2)
```
...
```{r}
cell_int_means <- emmeans(full_model_1a, pairwise ~ norm_condition*framing_condition, adjust = "none")
