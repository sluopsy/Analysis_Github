...
To do:
  ...
  * figure out multiple imputation dfs
  * figure out logistic regression interaction & emmeans analyses
  * post-hoc power analyses..?
     - modelPower
  * add effect sizes to simple effects analyses
  * check for skewness on values variables 
     - they are skewed... now what?
     - showing data on interaction plots to show where majority of data is congregating
