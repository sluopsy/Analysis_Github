...
To do:
  ...
  * add CIs to simple slope comparison tables?
    + should CIs or effect sizes be added?
  * how to test H3?
  * logistic analysis
    + simple effects?
    + marginal means/descriptives?
  * regression diagnostics for multiply imputed model
