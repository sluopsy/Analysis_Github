...
```{r}
D3(log_mice, log_minus_frameXnorm)
```
...
```{r}
D3(log_mice, log_minus_frameXbio)
```
...
```{r}
D3(log_mice, log_minus_frameXalt)
```
...
```{r}
D3(log_mice, log_minus_frameXego)
```
...
```{r}
D3(log_mice, log_minus_frameXhed)
```
...
```{r}
D3(log_mice, log_minus_frameXingroup)
```
...
```{r}
D3(log_mice, log_minus_normXbio)
```
...
```{r}
D3(log_mice, log_minus_normXalt)
```
...
```{r}
D3(log_mice, log_minus_normXego)
```
...
```{r}
D3(log_mice, log_minus_normXhed)
```
...
```{r}
D3(log_mice, log_minus_normXingroup)
```
...
```{r}
D3(log_mice, log_minus_frameXnormXbio)
```
...
```{r}
D3(log_mice, log_minus_frameXnormXalt)
```
...
```{r}
D3(log_mice, log_minus_frameXnormXego)
```
...
```{r}
D3(log_mice, log_minus_frameXnormXhed)
```
...
```{r}
D3(log_mice, log_minus_frameXnormXingroup)
```