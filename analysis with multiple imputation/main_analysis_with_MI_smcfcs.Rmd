...
Comparing each norm condition across framing conditions
```{r}
cell_emmeans
...
norm_across_framing <- contrast(cell_emmeans, method = list("Control: PE vs Control" = pf_cn_emm - cf_cn_emm,
                                                        "Control: SE vs Control" = sf_cn_emm - cf_cn_emm,
                                                        "Control: PE vs SE" = pf_cn_emm - sf_cn_emm,
                                                        "DN: PE vs Control" = pf_dn_emm - cf_dn_emm,
                                                        "DN: SE vs Control" = sf_dn_emm - cf_dn_emm,
                                                        "DN: PE vs SE" = pf_dn_emm - sf_dn_emm,
                                                        "Conv: PE vs Control" = pf_conv_emm - cf_conv_emm,
                                                        "Conv: SE vs Control" = sf_conv_emm - cf_conv_emm,
                                                        "Conv: PE vs SE" = pf_conv_emm - sf_conv_emm,
                                                        "SN: PE vs Control" = pf_sn_emm - cf_sn_emm,
                                                        "SN: SE vs Control" = sf_sn_emm - cf_sn_emm,
                                                        "SN: PE vs SE" = pf_sn_emm - sf_sn_emm,
                                                        "MN: PE vs Control" = pf_mn_emm - cf_mn_emm,
                                                        "MN: SE vs Control" = sf_mn_emm - cf_mn_emm,
                                                        "MN: PE vs SE" = pf_mn_emm - sf_mn_emm), adjust = "none")


norm_across_framing %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
# effect sizes
eff_size(cell_emmeans, method = list("Control: PE vs Control" = pf_cn_emm - cf_cn_emm,
                                                        "Control: SE vs Control" = sf_cn_emm - cf_cn_emm,
                                                        "Control: PE vs SE" = pf_cn_emm - sf_cn_emm,
                                     "DN: PE vs Control" = pf_dn_emm - cf_dn_emm,
                                                        "DN: SE vs Control" = sf_dn_emm - cf_dn_emm,
                                                        ...
                                                        "MN: PE vs Control" = pf_mn_emm - cf_mn_emm,
                                                        "MN: SE vs Control" = sf_mn_emm - cf_mn_emm,
                                                        "MN: PE vs SE" = pf_mn_emm - sf_mn_emm), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
