...
emmip(mod_mice, ~ framing_condition, CIs = TRUE, xlab = "Framing Condition", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, ~ norm_condition, CIs = TRUE, xlab = "Norm Condition", ylab = "Consumer Intentions")
```
...
```{r}
emtrends(mod_mice, ~norm_condition, var = "biospheric_center", adjust = "none")


# On a single graph
at_list <- list(biospheric_center = seq(-5, 1.3, by = 1))

emmip(mod_mice, norm_condition ~ biospheric_center, at = at_list, CIs = TRUE, xlab = "Biospheric Values (centered)", ylab = "Consumer Intentions")
```
...
```{r}
emtrends(mod_mice, pairwise~norm_condition, var = "biospheric_center", adjust = "none")
```
...
emmip(mod_mice, framing_condition ~ biospheric_center, at = at_list, CIs = TRUE, xlab = "Biospheric Values (centered)", ylab = "Consumer Intentions")
```
...
```{r}
emtrends(mod_mice, pairwise~framing_condition, var = "biospheric_center", adjust = "none")
```
...
```{r}
emtrends(mod_mice, ~norm_condition | framing_condition, var = "biospheric_center", adjust = "none")

# Separate graph for each framing condition
at_list <- list(biospheric_center = seq(-5, 1.3, by = 1))

emmip(mod_mice, norm_condition ~ biospheric_center | framing_condition, at = at_list, CIs = TRUE, xlab = "Biospheric Values (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, norm_condition ~ altruistic_center, at = at_list, CIs = TRUE, xlab = "Altruistic Values (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, framing_condition ~ altruistic_center, at = at_list, CIs = TRUE, xlab = "Altruistic Values (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, norm_condition ~ altruistic_center | framing_condition, at = at_list, CIs = TRUE, xlab = "Altruistic Values (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, norm_condition ~ egoistic_center, at = at_list, CIs = TRUE, xlab = "Egoistic Values (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, framing_condition ~ egoistic_center, at = at_list, CIs = TRUE, xlab = "Egoistic Values (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, norm_condition ~ egoistic_center | framing_condition, at = at_list, CIs = TRUE, xlab = "Egoistic Values (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, norm_condition ~ hedonic_center, at = at_list, CIs = TRUE, xlab = "Hedonic Values (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, framing_condition ~ hedonic_center, at = at_list, CIs = TRUE, xlab = "Hedonic Values (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, norm_condition ~ hedonic_center | framing_condition, at = at_list, CIs = TRUE, xlab = "Hedonic Values (centered)", ylab = "Consumer Intentions")
```
...
# On a single graph
at_list <- list(ingroup_center = seq(-3.8, 2.6, by = 1))

emmip(mod_mice, norm_condition ~ ingroup_center, at = at_list, CIs = TRUE, xlab = "Ingroup Identification (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, framing_condition ~ ingroup_center, at = at_list, CIs = TRUE, xlab = "Ingroup Identification (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, norm_condition ~ ingroup_center | framing_condition, at = at_list, CIs = TRUE, xlab = "Ingroup Identification (centered)", ylab = "Consumer Intentions")
```
...
emmip(mod_mice, Gender ~ norm_condition | framing_condition, CIs = FALSE, xlab = "Norm Condition", ylab = "Consumer Intentions")

emmip(mod_mice, Gender ~ framing_condition | norm_condition, CIs = FALSE, xlab = "Norm Condition", ylab = "Consumer Intentions")
...
see if this works for producing anova table... 
```{r}
#anova(pool(log_mice)) %>%
 # knitr::kable(digits = 3)
```
...
### Testing framingXnorm interaction
```{r}
...
* residual deviance = 1342
* residual deviance from full log model = 1335

```{r}
D1(log_mice, log_minus_frameXnorm)
```

* Inclusion of framing X norm interaction does not account for significantly more variance in the model


### Testing framingXbiospheric interaction
```{r}
...
* df_residual = 1038 (1038 is df_resid from full log model)
* residual deviance = 1335 (same as full log model)

```{r}
D1(log_mice, log_minus_frameXbio)
```




### Testing framingXaltruistic interaction
```{r}
...
```{r}
D1(log_mice, log_minus_frameXalt)
```



### Testing framingXegoistic interaction
```{r}
...
```{r}
D1(log_mice, log_minus_frameXego)
```



### Testing framingXhedonic interaction
```{r}
...
```{r}
D1(log_mice, log_minus_frameXhed)
```



### Testing frameXingroup interaction
```{r}
...
```{r}
D1(log_mice, log_minus_frameXingroup)
```
...
### Testing normXbiospheric interaction
```{r}
...
```{r}
D1(log_mice, log_minus_normXbio)
```




### Testing normXaltruistic interaction
```{r}
...
```{r}
D1(log_mice, log_minus_normXalt)
```



### Testing normXegoistic interaction
```{r}
...
```{r}
D1(log_mice, log_minus_normXego)
```



### Testing normXhedonic interaction
```{r}
...
```{r}
D1(log_mice, log_minus_normXhed)
```



### Testing normXingroup interaction
```{r}
...
```{r}
D1(log_mice, log_minus_normXingroup)
```
...
### Testing frameXnormXbiospheric interaction
```{r}
...
```{r}
D1(log_mice, log_minus_frameXnormXbio)
```




### Testing frameXnormXaltruistic interaction
```{r}
...
* df_residual = 1046
* residual deviance = 1344

```{r}
D1(log_mice, log_minus_frameXnormXalt)
```



### Testing frameXnormXegoistic interaction
```{r}
...
* df_residual = 1046
* residual deviance = 1339

```{r}
D1(log_mice, log_minus_frameXnormXego)
```



### Testing frameXnormXhedonic interaction
```{r}
...
```{r}
D1(log_mice, log_minus_frameXnormXhed)
```



### Testing frameXnormXingroup interaction
```{r}
...
```{r}
D1(log_mice, log_minus_frameXnormXingroup)
```