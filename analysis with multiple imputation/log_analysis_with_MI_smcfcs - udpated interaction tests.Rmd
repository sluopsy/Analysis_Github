...
# Additional norm X framing interaction 

Looking at differences for the same norm-intervention condition across framing conditions
...
## Contrasting norms across framings
```{r}
norm_across_framing <- contrast(cell_emmeans_prob, method = list("Control: PE vs Control" = pf_cn_emm - cf_cn_emm,
...
norm_across_framing %>% knitr::kable(digits = c(NA,2,2,2,2,2,3))
