---
title: "Values Three-Way Interactions"
output:
  html_document:
    toc: yes
    toc_depth: 3
...
```{r}
# Biospheric slopes
bio_slopes <- emtrends(mod_mice, ~norm_condition*framing_condition, var = "biospheric_center")

bio_slopes %>%
  knitr::kable(digits = 2)

# Altruistic values
alt_slopes <- emtrends(mod_mice, ~norm_condition*framing_condition, var = "altruistic_center")

alt_slopes %>%
  knitr::kable(digits = 2)

# Egoistic values
ego_slopes <- emtrends(mod_mice, ~norm_condition*framing_condition, var = "egoistic_center")

ego_slopes %>%
  knitr::kable(digits = 2)

# Hedonic values
hed_slopes <- emtrends(mod_mice, ~norm_condition*framing_condition, var = "hedonic_center")

hed_slopes %>%
  knitr::kable(digits = 2)

# Ingroup identification
ing_slopes <- emtrends(mod_mice, ~norm_condition*framing_condition, var = "ingroup_center")
...
combinations <- emmeans(mod_mice, ~ norm_condition*biospheric_center*framing_condition, at=atlist)
...
controlframe_lowvshi_bio %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, method = list("CF/DN/LowBio - CF/CN/LowBio" = cf_dn_low_bio - cf_cn_low_bio,
                                     "CF/Conv/LowBio - CF/CN/LowBio" = cf_conv_low_bio - cf_cn_low_bio,
                                     "CF/SN/LowBio - CF/CN/LowBio" = cf_sn_low_bio - cf_cn_low_bio,
                                     "CF/MN/LowBio - CF/CN/LowBio" = cf_mn_low_bio - cf_cn_low_bio,
                                     "CF/DN/HiBio - CF/CN/HiBio" = cf_dn_hi_bio - cf_cn_hi_bio,
                                     "CF/Conv/HiBio - CF/CN/HiBio" = cf_conv_hi_bio - cf_cn_hi_bio,
                                     "CF/SN/HiBio - CF/CN/HiBio" = cf_sn_hi_bio - cf_cn_hi_bio,
                                     "CF/MN/HiBio - CF/CN/HiBio" = cf_mn_hi_bio - cf_cn_hi_bio), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
compare_bio %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
# effect sizes
eff_size(controlframe_lowvshi_bio, method = list("Effect of DN (Low - High Bio)" = dn_vs_c_lowbio - dn_vs_c_hibio, 
                                                                "Effect of Conv (Low - High Bio)" = conv_vs_c_lowbio - conv_vs_c_hibio,
                                                                "Effect of SN (Low - High Bio)" = sn_vs_c_lowbio - sn_vs_c_hibio,
                                                                "Effect of MN (Low - High Bio)" = mn_vs_c_lowbio - mn_vs_c_hibio), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
proenvframe_lowvshi_bio %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
# effect sizes
eff_size(combinations, method = list("PF/DN/LowBio - PF/CN/LowBio" = pf_dn_low_bio - pf_cn_low_bio,
                                     "PF/Conv/LowBio - PF/CN/LowBio" = pf_conv_low_bio - pf_cn_low_bio,
                                     "PF/SN/LowBio - PF/CN/LowBio" = pf_sn_low_bio - pf_cn_low_bio,
                                     "PF/MN/LowBio - PF/CN/LowBio" = pf_mn_low_bio - pf_cn_low_bio,
                                     "PF/DN/HiBio - PF/CN/HiBio" = pf_dn_hi_bio - pf_cn_hi_bio,
                                     "PF/Conv/HiBio - PF/CN/HiBio" = pf_conv_hi_bio - pf_cn_hi_bio,
                                     "PF/SN/HiBio - PF/CN/HiBio" = pf_sn_hi_bio - pf_cn_hi_bio,
                                     "PF/MN/HiBio - PF/CN/HiBio" = pf_mn_hi_bio - pf_cn_hi_bio), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
# effect sizes
eff_size(proenvframe_lowvshi_bio, method = list("Effect of DN (Low - High Bio)" = dn_vs_c_lowbio - dn_vs_c_hibio, 
                                                                "Effect of Conv (Low - High Bio)" = conv_vs_c_lowbio - conv_vs_c_hibio,
                                                                "Effect of SN (Low - High Bio)" = sn_vs_c_lowbio - sn_vs_c_hibio,
                                                                "Effect of MN (Low - High Bio)" = mn_vs_c_lowbio - mn_vs_c_hibio), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
selfenhframe_lowvshi_bio %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
# effect sizes
eff_size(combinations, method = list("SF/DN/LowBio - SF/CN/LowBio" = sf_dn_low_bio - sf_cn_low_bio,
                                     "SF/Conv/LowBio - SF/CN/LowBio" = sf_conv_low_bio - sf_cn_low_bio,
                                     "SF/SN/LowBio - SF/CN/LowBio" = sf_sn_low_bio - sf_cn_low_bio,
                                     "SF/MN/LowBio - SF/CN/LowBio" = sf_mn_low_bio - sf_cn_low_bio,
                                     "SF/DN/HiBio - SF/CN/HiBio" = sf_dn_hi_bio - sf_cn_hi_bio,
                                     "SF/Conv/HiBio - SF/CN/HiBio" = sf_conv_hi_bio - sf_cn_hi_bio,
                                     "SF/SN/HiBio - SF/CN/HiBio" = sf_sn_hi_bio - sf_cn_hi_bio,
                                     "SF/MN/HiBio - SF/CN/HiBio" = sf_mn_hi_bio - sf_cn_hi_bio), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
# effect sizes
eff_size(selfenhframe_lowvshi_bio, method = list("Effect of DN (Low - High Bio)" = dn_vs_c_lowbio - dn_vs_c_hibio, 
                                                                "Effect of Conv (Low - High Bio)" = conv_vs_c_lowbio - conv_vs_c_hibio,
                                                                "Effect of SN (Low - High Bio)" = sn_vs_c_lowbio - sn_vs_c_hibio,
                                                                "Effect of MN (Low - High Bio)" = mn_vs_c_lowbio - mn_vs_c_hibio), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
### Visualization of Three-way Interaction with Bio Values
```{r}
text_settings <- theme(text = element_text(size = 20)) +
  theme(plot.title = element_text(size = 20, face = 'bold')) +
  theme(axis.title.x = element_text(face = 'bold')) +
  theme(axis.title.y = element_text(face = 'bold')) +
  theme(axis.text.x = element_text(size = 14, 'bold')) +
  theme(axis.text.y = element_text(size = 20)) +
  theme(axis.ticks = element_blank()) 
```
...
emmip(mod_mice, biospheric_center ~ framing_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Framing Condition", ylab = "Consumer Intentions", at = at_list) + 
  ...
  theme_apa() +
  text_settings +
  scale_color_manual(name = "Biospheric Values", breaks = c(-0.992298742865129, 0.992298742865129), labels = c("-1SD Biospheric", "+1SD Biospheric"), values = c("#00BFC4","#C77CFF"))
  
```

#### Bio x Norm
```{r}
emmip(mod_mice, biospheric_center ~ norm_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Norm Condition", ylab = "Consumer Intentions", at = at_list) + 
...
#### Bio, Framing, & Norm
```{r}
emmip(mod_mice, biospheric_center ~ norm_condition | framing_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Norm Condition", ylab = "Consumer Intentions", at = at_list) + 
...
combinations <- emmeans(mod_mice, ~ norm_condition*altruistic_center*framing_condition, at=atlist)
...
controlframe_lowvshi_alt %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, method = list("CF/DN/LowAlt - CF/CN/LowAlt" = cf_dn_low_alt - cf_cn_low_alt,
                                     "CF/Conv/LowAlt - CF/CN/LowAlt" = cf_conv_low_alt - cf_cn_low_alt,
                                     "CF/SN/LowAlt - CF/CN/LowAlt" = cf_sn_low_alt - cf_cn_low_alt,
                                     "CF/MN/LowAlt - CF/CN/LowAlt" = cf_mn_low_alt - cf_cn_low_alt,
                                     "CF/DN/HiAlt - CF/CN/HiAlt" = cf_dn_hi_alt - cf_cn_hi_alt,
                                     "CF/Conv/HiAlt - CF/CN/HiAlt" = cf_conv_hi_alt - cf_cn_hi_alt,
                                     "CF/SN/HiAlt - CF/CN/HiAlt" = cf_sn_hi_alt - cf_cn_hi_alt,
                                     "CF/MN/HiAlt - CF/CN/HiAlt" = cf_mn_hi_alt - cf_cn_hi_alt), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
compare_alt %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
# effect sizes
eff_size(controlframe_lowvshi_alt, method = list("Effect of DN (Low - High alt)" = dn_vs_c_LowAlt - dn_vs_c_HiAlt, 
                                                                "Effect of Conv (Low - High alt)" = conv_vs_c_LowAlt - conv_vs_c_HiAlt,
                                                                "Effect of SN (Low - High alt)" = sn_vs_c_LowAlt - sn_vs_c_HiAlt,
                                                                "Effect of MN (Low - High alt)" = mn_vs_c_LowAlt - mn_vs_c_HiAlt), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
proenvframe_lowvshi_alt %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("PF/DN/LowAlt - PF/CN/LowAlt" = pf_dn_low_alt - pf_cn_low_alt,
                                     ...
                                     "PF/Conv/HiAlt - PF/CN/HiAlt" = pf_conv_hi_alt - pf_cn_hi_alt,
                                     "PF/SN/HiAlt - PF/CN/HiAlt" = pf_sn_hi_alt - pf_cn_hi_alt,
                                     "PF/MN/HiAlt - PF/CN/HiAlt" = pf_mn_hi_alt - pf_cn_hi_alt), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
# effect sizes
eff_size(proenvframe_lowvshi_alt, method = list("Effect of DN (Low - High alt)" = dn_vs_c_LowAlt - dn_vs_c_HiAlt, 
                                                                "Effect of Conv (Low - High alt)" = conv_vs_c_LowAlt - conv_vs_c_HiAlt,
                                                                "Effect of SN (Low - High alt)" = sn_vs_c_LowAlt - sn_vs_c_HiAlt,
                                                                "Effect of MN (Low - High alt)" = mn_vs_c_LowAlt - mn_vs_c_HiAlt), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
selfenhframe_lowvshi_alt %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("SF/DN/LowAlt - SF/CN/LowAlt" = sf_dn_low_alt - sf_cn_low_alt,
                                     ...
                                     "SF/Conv/HiAlt - SF/CN/HiAlt" = sf_conv_hi_alt - sf_cn_hi_alt,
                                     "SF/SN/HiAlt - SF/CN/HiAlt" = sf_sn_hi_alt - sf_cn_hi_alt,
                                     "SF/MN/HiAlt - SF/CN/HiAlt" = sf_mn_hi_alt - sf_cn_hi_alt), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
# effect sizes
eff_size(selfenhframe_lowvshi_alt, method = list("Effect of DN (Low - High alt)" = dn_vs_c_LowAlt - dn_vs_c_HiAlt, 
                                                                "Effect of Conv (Low - High alt)" = conv_vs_c_LowAlt - conv_vs_c_HiAlt,
                                                                "Effect of SN (Low - High alt)" = sn_vs_c_LowAlt - sn_vs_c_HiAlt,
                                                                "Effect of MN (Low - High alt)" = mn_vs_c_LowAlt - mn_vs_c_HiAlt), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
### Visualization of Three-way Interaction with Altruistic Values
...
emmip(mod_mice, altruistic_center ~ framing_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Framing Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_framing","pro_env_framing", "self_enh_framing"), labels = c("Control Framing", "Pro-environmental Framing", "Self-enhancing Framing")) +
  theme_apa() +
  text_settings +
  scale_color_manual(name = "Altruistic Values", breaks = c(-0.803645207958345, 0.803645207958345), labels = c("-1SD Altruistic", "+1SD Altruistic"), values = c("#00BFC4","#C77CFF"))
  
```

#### Alt x Norm
```{r}
emmip(mod_mice, altruistic_center ~ norm_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Norm Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_norm","descriptive_norm", "convention_norm", "social_norm", "moral_norm"), labels = c("Control Norm", "Descriptive Norm", "Convention", "Social Norm", "Moral Norm")) +
  theme_apa() +
  text_settings +
  scale_color_manual(name = "Altruistic Values", breaks = c(-0.803645207958345, 0.803645207958345), labels = c("-1SD Altruistic", "+1SD Altruistic"), values = c("#00BFC4","#C77CFF"))
...
```{r}
emmip(mod_mice, altruistic_center ~ norm_condition | framing_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Norm Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_norm","descriptive_norm", "convention_norm", "social_norm", "moral_norm"), labels = c("Control", "Descriptive", "Convention", "Social", "Moral")) +
  facet_wrap(~framing_condition, labeller = labeller(framing_condition = frame_labs)) +
  theme_apa() +
  text_settings +
...
combinations <- emmeans(mod_mice, ~ norm_condition*egoistic_center*framing_condition, at=atlist)
...
controlframe_lowvshi_ego %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("CF/DN/LowEgo - CF/CN/LowEgo" = cf_dn_low_ego - cf_cn_low_ego,
                                     ...
                                     "CF/Conv/HiEgo - CF/CN/HiEgo" = cf_conv_hi_ego - cf_cn_hi_ego,
                                     "CF/SN/HiEgo - CF/CN/HiEgo" = cf_sn_hi_ego - cf_cn_hi_ego,
                                     "CF/MN/HiEgo - CF/CN/HiEgo" = cf_mn_hi_ego - cf_cn_hi_ego), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
compare_ego %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
# effect sizes
eff_size(controlframe_lowvshi_ego, method = list("Effect of DN (Low - High ego)" = dn_vs_c_LowEgo - dn_vs_c_HiEgo, 
                                                                "Effect of Conv (Low - High ego)" = conv_vs_c_LowEgo - conv_vs_c_HiEgo,
                                                                "Effect of SN (Low - High ego)" = sn_vs_c_LowEgo - sn_vs_c_HiEgo,
                                                                "Effect of MN (Low - High ego)" = mn_vs_c_LowEgo - mn_vs_c_HiEgo),  sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
proenvframe_lowvshi_ego %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("PF/DN/LowEgo - PF/CN/LowEgo" = pf_dn_low_ego - pf_cn_low_ego,
                                     ...
                                     "PF/Conv/HiEgo - PF/CN/HiEgo" = pf_conv_hi_ego - pf_cn_hi_ego,
                                     "PF/SN/HiEgo - PF/CN/HiEgo" = pf_sn_hi_ego - pf_cn_hi_ego,
                                     "PF/MN/HiEgo - PF/CN/HiEgo" = pf_mn_hi_ego - pf_cn_hi_ego),  sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
# effect sizes
eff_size(proenvframe_lowvshi_ego, method = list("Effect of DN (Low - High ego)" = dn_vs_c_LowEgo - dn_vs_c_HiEgo, 
                                                                "Effect of Conv (Low - High ego)" = conv_vs_c_LowEgo - conv_vs_c_HiEgo,
                                                                "Effect of SN (Low - High ego)" = sn_vs_c_LowEgo - sn_vs_c_HiEgo,
                                                                "Effect of MN (Low - High ego)" = mn_vs_c_LowEgo - mn_vs_c_HiEgo), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
selfenhframe_lowvshi_ego %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("SF/DN/LowEgo - SF/CN/LowEgo" = sf_dn_low_ego - sf_cn_low_ego,
                                     ...
                                     "SF/Conv/HiEgo - SF/CN/HiEgo" = sf_conv_hi_ego - sf_cn_hi_ego,
                                     "SF/SN/HiEgo - SF/CN/HiEgo" = sf_sn_hi_ego - sf_cn_hi_ego,
                                     "SF/MN/HiEgo - SF/CN/HiEgo" = sf_mn_hi_ego - sf_cn_hi_ego), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
# effect sizes
eff_size(selfenhframe_lowvshi_ego, method = list("Effect of DN (Low - High ego)" = dn_vs_c_LowEgo - dn_vs_c_HiEgo, 
                                                                "Effect of Conv (Low - High ego)" = conv_vs_c_LowEgo - conv_vs_c_HiEgo,
                                                                "Effect of SN (Low - High ego)" = sn_vs_c_LowEgo - sn_vs_c_HiEgo,
                                                                "Effect of MN (Low - High ego)" = mn_vs_c_LowEgo - mn_vs_c_HiEgo), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
### Visualization of Three-way Interaction with Ego Values
...
emmip(mod_mice, egoistic_center ~ framing_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Framing Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_framing","pro_env_framing", "self_enh_framing"), labels = c("Control Framing", "Pro-environmental Framing", "Self-enhancing Framing")) +
  theme_apa() +
  text_settings +
  scale_color_manual(name = "Egoistic Values", breaks = c(-0.916840867752407, 0.916840867752407), labels = c("-1SD Egoistic", "+1SD Egoistic"), values = c("#00BFC4","#C77CFF"))
  
```

#### Ego x Norm
```{r}
emmip(mod_mice, egoistic_center ~ norm_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Norm Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_norm","descriptive_norm", "convention_norm", "social_norm", "moral_norm"), labels = c("Control Norm", "Descriptive Norm", "Convention", "Social Norm", "Moral Norm")) +
  theme_apa() +
  text_settings +
  scale_color_manual(name = "Egoistic Values", breaks = c(-0.916840867752407, 0.916840867752407), labels = c("-1SD Egoistic", "+1SD Egoistic"), values = c("#00BFC4","#C77CFF"))
...
#### Ego, Norm, Framing
```{r}
emmip(mod_mice, egoistic_center ~ norm_condition | framing_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Norm Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_norm","descriptive_norm", "convention_norm", "social_norm", "moral_norm"), labels = c("Control", "Descriptive", "Convention", "Social", "Moral")) +
  facet_wrap(~framing_condition, labeller = labeller(framing_condition = frame_labs)) +
  theme_apa() +
  text_settings +
...
combinations <- emmeans(mod_mice, ~ norm_condition*hedonic_center*framing_condition, at=atlist)
...
controlframe_lowvshi_hed %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("CF/DN/LowHed - CF/CN/LowHed" = cf_dn_low_hed - cf_cn_low_hed,
                                     ...
                                     "CF/Conv/HiHed - CF/CN/HiHed" = cf_conv_hi_hed - cf_cn_hi_hed,
                                     "CF/SN/HiHed - CF/CN/HiHed" = cf_sn_hi_hed - cf_cn_hi_hed,
                                     "CF/MN/HiHed - CF/CN/HiHed" = cf_mn_hi_hed - cf_cn_hi_hed), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
compare_hed %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
# effect sizes
eff_size(controlframe_lowvshi_hed, method = list("Effect of DN (Low - High hed)" = dn_vs_c_LowHed - dn_vs_c_HiHed, 
                                                                "Effect of Conv (Low - High hed)" = conv_vs_c_LowHed - conv_vs_c_HiHed,
                                                                "Effect of SN (Low - High hed)" = sn_vs_c_LowHed - sn_vs_c_HiHed,
                                                                "Effect of MN (Low - High hed)" = mn_vs_c_LowHed - mn_vs_c_HiHed), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
proenvframe_lowvshi_hed %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("PF/DN/LowHed - PF/CN/LowHed" = pf_dn_low_hed - pf_cn_low_hed,
                                     ...
                                     "PF/Conv/HiHed - PF/CN/HiHed" = pf_conv_hi_hed - pf_cn_hi_hed,
                                     "PF/SN/HiHed - PF/CN/HiHed" = pf_sn_hi_hed - pf_cn_hi_hed,
                                     "PF/MN/HiHed - PF/CN/HiHed" = pf_mn_hi_hed - pf_cn_hi_hed), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
# effect sizes
eff_size(proenvframe_lowvshi_hed, method = list("Effect of DN (Low - High hed)" = dn_vs_c_LowHed - dn_vs_c_HiHed, 
                                                                "Effect of Conv (Low - High hed)" = conv_vs_c_LowHed - conv_vs_c_HiHed,
                                                                "Effect of SN (Low - High hed)" = sn_vs_c_LowHed - sn_vs_c_HiHed,
                                                                "Effect of MN (Low - High hed)" = mn_vs_c_LowHed - mn_vs_c_HiHed), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
selfenhframe_lowvshi_hed %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("SF/DN/LowHed - SF/CN/LowHed" = sf_dn_low_hed - sf_cn_low_hed,
                                     ...
                                     "SF/Conv/HiHed - SF/CN/HiHed" = sf_conv_hi_hed - sf_cn_hi_hed,
                                     "SF/SN/HiHed - SF/CN/HiHed" = sf_sn_hi_hed - sf_cn_hi_hed,
                                     "SF/MN/HiHed - SF/CN/HiHed" = sf_mn_hi_hed - sf_cn_hi_hed), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
# effect sizes
eff_size(selfenhframe_lowvshi_hed, method = list("Effect of DN (Low - High hed)" = dn_vs_c_LowHed - dn_vs_c_HiHed, 
                                                                "Effect of Conv (Low - High hed)" = conv_vs_c_LowHed - conv_vs_c_HiHed,
                                                                "Effect of SN (Low - High hed)" = sn_vs_c_LowHed - sn_vs_c_HiHed,
                                                                "Effect of MN (Low - High hed)" = mn_vs_c_LowHed - mn_vs_c_HiHed), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
### Visualization of Three-way Interaction with Hedonic Values
```{r}
text_settings <- theme(text = element_text(size = 20)) +
  theme(plot.title = element_text(size = 20, face = 'bold')) +
  theme(axis.title.x = element_text(face = 'bold')) +
...
emmip(mod_mice, hedonic_center ~ framing_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Framing Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_framing","pro_env_framing", "self_enh_framing"), labels = c("Control Framing", "Pro-environmental Framing", "Self-enhancing Framing")) +
  theme_apa() +
  text_settings +
  scale_color_manual(name = "Hedonic Values", breaks = c(-0.791118625256819, 0.791118625256819), labels = c("-1SD Hedonic", "+1SD Hedonic"), values = c("#00BFC4","#C77CFF"))
  
```

#### Hed x Norm
```{r}
emmip(mod_mice, hedonic_center ~ norm_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Norm Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_norm","descriptive_norm", "convention_norm", "social_norm", "moral_norm"), labels = c("Control Norm", "Descriptive Norm", "Convention", "Social Norm", "Moral Norm")) +
  theme_apa() +
  text_settings +
  scale_color_manual(name = "Hedonic Values", breaks = c(-0.791118625256819, 0.791118625256819), labels = c("-1SD Hedonic", "+1SD Hedonic"), values = c("#00BFC4","#C77CFF"))
...
#### Hed, Norm, Framing
```{r}
emmip(mod_mice, hedonic_center ~ norm_condition | framing_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Norm Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_norm","descriptive_norm", "convention_norm", "social_norm", "moral_norm"), labels = c("Control", "Descriptive", "Convention", "Social", "Moral")) +
  facet_wrap(~framing_condition, labeller = labeller(framing_condition = frame_labs)) +
  theme_apa() +
  text_settings +
...
combinations <- emmeans(mod_mice, ~ norm_condition*ingroup_center*framing_condition, at=atlist)
...
controlframe_lowvshi_ing %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("CF/DN/LowIng - CF/CN/LowIng" = cf_dn_low_ing - cf_cn_low_ing,
                                     ...
                                     "CF/Conv/HiIng - CF/CN/HiIng" = cf_conv_hi_ing - cf_cn_hi_ing,
                                     "CF/SN/HiIng - CF/CN/HiIng" = cf_sn_hi_ing - cf_cn_hi_ing,
                                     "CF/MN/HiIng - CF/CN/HiIng" = cf_mn_hi_ing - cf_cn_hi_ing), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
compare_ing %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
# effect sizes
eff_size(controlframe_lowvshi_ing, method = list("Effect of DN (Low - High ing)" = dn_vs_c_LowIng - dn_vs_c_HiIng, 
                                                                "Effect of Conv (Low - High ing)" = conv_vs_c_LowIng - conv_vs_c_HiIng,
                                                                "Effect of SN (Low - High ing)" = sn_vs_c_LowIng - sn_vs_c_HiIng,
                                                                "Effect of MN (Low - High ing)" = mn_vs_c_LowIng - mn_vs_c_HiIng), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
proenvframe_lowvshi_ing %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("PF/DN/LowIng - PF/CN/LowIng" = pf_dn_low_ing - pf_cn_low_ing,
                                     ...
                                     "PF/Conv/HiIng - PF/CN/HiIng" = pf_conv_hi_ing - pf_cn_hi_ing,
                                     "PF/SN/HiIng - PF/CN/HiIng" = pf_sn_hi_ing - pf_cn_hi_ing,
                                     "PF/MN/HiIng - PF/CN/HiIng" = pf_mn_hi_ing - pf_cn_hi_ing), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
# effect sizes
eff_size(proenvframe_lowvshi_ing, method = list("Effect of DN (Low - High ing)" = dn_vs_c_LowIng - dn_vs_c_HiIng, 
                                                                "Effect of Conv (Low - High ing)" = conv_vs_c_LowIng - conv_vs_c_HiIng,
                                                                "Effect of SN (Low - High ing)" = sn_vs_c_LowIng - sn_vs_c_HiIng,
                                                                "Effect of MN (Low - High ing)" = mn_vs_c_LowIng - mn_vs_c_HiIng), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
selfenhframe_lowvshi_ing %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("SF/DN/LowIng - SF/CN/LowIng" = sf_dn_low_ing - sf_cn_low_ing,
                                     ...
                                     "SF/Conv/HiIng - SF/CN/HiIng" = sf_conv_hi_ing - sf_cn_hi_ing,
                                     "SF/SN/HiIng - SF/CN/HiIng" = sf_sn_hi_ing - sf_cn_hi_ing,
                                     "SF/MN/HiIng - SF/CN/HiIng" = sf_mn_hi_ing - sf_cn_hi_ing), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
# effect sizes
eff_size(selfenhframe_lowvshi_ing, method = list("Effect of DN (Low - High ing)" = dn_vs_c_LowIng - dn_vs_c_HiIng, 
                                                                "Effect of Conv (Low - High ing)" = conv_vs_c_LowIng - conv_vs_c_HiIng,
                                                                "Effect of SN (Low - High ing)" = sn_vs_c_LowIng - sn_vs_c_HiIng,
                                                                "Effect of MN (Low - High ing)" = mn_vs_c_LowIng - mn_vs_c_HiIng), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
norm_effect_ing %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
eff_size(combinations, 
                       method = list("DN Low Ing - Control Low Ing" = dn_low_ing - cn_low_ing,
                                     ...
                                     "Conv Hi Ing - Control Hi Ing" = conv_hi_ing - cn_hi_ing,
                                     "SN Hi Ing - Control Hi Ing" = sn_hi_ing - cn_hi_ing,
                                     "MN Hi Ing - Control Hi Ing" = mn_hi_ing - cn_hi_ing), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2) # need to fix
```
...
norm_compare_ing %>% knitr::kable(digits = c(NA,2,2,2,2,3))
...
# effect sizes
eff_size(norm_effect_ing, method = list("Effect of DN (Low - High ing)" = dn_vs_c_LowIng - dn_vs_c_HiIng, 
                                                                "Effect of Conv (Low - High ing)" = conv_vs_c_LowIng - conv_vs_c_HiIng,
                                                                "Effect of SN (Low - High ing)" = sn_vs_c_LowIng - sn_vs_c_HiIng,
                                                                "Effect of MN (Low - High ing)" = mn_vs_c_LowIng - mn_vs_c_HiIng), sigma = sigma_pool, edf = df_resid_pool) %>% knitr::kable(digits = 2)
```
...
### Visualization of Three-way Interaction with Ingroup Id
```{r}
text_settings <- theme(text = element_text(size = 20)) +
  theme(plot.title = element_text(size = 20, face = 'bold')) +
  theme(axis.title.x = element_text(face = 'bold')) +
...
emmip(mod_mice, ingroup_center ~ framing_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Framing Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_framing","pro_env_framing", "self_enh_framing"), labels = c("Control Framing", "Pro-environmental Framing", "Self-enhancing Framing")) +
  theme_apa() +
  text_settings +
...
#### Ingroup x Norm
```{r}
emmip(mod_mice, ingroup_center ~ norm_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Norm Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_norm","descriptive_norm", "convention_norm", "social_norm", "moral_norm"), labels = c("Control Norm", "Descriptive Norm", "Convention", "Social Norm", "Moral Norm")) +
  theme_apa() +
  text_settings +
  scale_color_manual(name = "Ingroup Identification", breaks = c(-1.01218644014995, 1.01218644014995), labels = c("-1SD Ingroup", "+1SD Ingroup"), values = c("#00BFC4","#C77CFF"))
...
```{r}
emmip(mod_mice, ingroup_center ~ norm_condition | framing_condition, CIs = TRUE, CIarg = list(lwd = 1.2, alpha = 1), xlab = "Norm Condition", ylab = "Consumer Intentions", at = at_list) + 
  scale_x_discrete(breaks=c("control_norm","descriptive_norm", "convention_norm", "social_norm", "moral_norm"), labels = c("Control", "Descriptive", "Convention", "Social", "Moral")) +
  facet_wrap(~framing_condition, labeller = labeller(framing_condition = frame_labs)) +
  theme_apa() +
  text_settings +
...
```{r}
alt_norm_slopes <- emtrends(mod_mice, pairwise~norm_condition, var = "altruistic_center", adjust = "none")

alt_norm_slopes$emtrends %>%
  knitr::kable(digits = 2)

alt_norm_slopes$contrasts %>%
  knitr::kable(digits = c(NA,2,2,2,2,3)) # correct p-values
```

Confidence interval
```{r}
confint(alt_norm_slopes$contrasts) %>%
  knitr::kable(digits = 2)
```
...
### Altruistic x Norm x Framing

```{r}
alt_frame_norm_trends <- emtrends(mod_mice, pairwise~norm_condition | framing_condition, var = "altruistic_center", adjust = "none")

alt_frame_norm_trends$emtrends %>%
  knitr::kable(digits = 2)

alt_frame_norm_trends$contrasts %>%
  knitr::kable(digits = c(NA,NA,2,2,2,2,3))
```

Confidence interval
```{r}
confint(alt_frame_norm_trends$contrasts) %>%
  knitr::kable(digits = 2)
```
...
```{r}
ego_norm_slopes <- emtrends(mod_mice, pairwise~norm_condition, var = "egoistic_center", adjust = "none")

ego_norm_slopes$emtrends %>%
  knitr::kable(digits = 2)

ego_norm_slopes$contrasts %>%
  knitr::kable(digits = c(NA,2,2,2,2,3)) # correct p-values
```

Confidence interval
```{r}
confint(ego_norm_slopes$contrasts) %>%
  knitr::kable(digits = 2)
```
...
### Egoistic x Norm x Framing

```{r}
ego_frame_norm_trends <- emtrends(mod_mice, pairwise~norm_condition | framing_condition, var = "egoistic_center", adjust = "none")

ego_frame_norm_trends$emtrends %>%
  knitr::kable(digits = 2)

ego_frame_norm_trends$contrasts %>%
  knitr::kable(digits = c(NA,NA,2,2,2,2,3))
```

Confidence interval
```{r}
confint(ego_frame_norm_trends$contrasts) %>%
  knitr::kable(digits = 2)
```
...
```{r}
hed_norm_slopes <- emtrends(mod_mice, pairwise~norm_condition, var = "hedonic_center", adjust = "none")

hed_norm_slopes$emtrends %>%
  knitr::kable(digits = 2)

hed_norm_slopes$contrasts %>%
  knitr::kable(digits = c(NA,2,2,2,2,3)) # correct p-values
```

Confidence interval
```{r}
confint(hed_norm_slopes$contrasts) %>%
  knitr::kable(digits = 2)
```
...
### Hedonic x Norm x Framing

```{r}
hed_frame_norm_trends <- emtrends(mod_mice, pairwise~norm_condition | framing_condition, var = "hedonic_center", adjust = "none")

hed_frame_norm_trends$emtrends %>%
  knitr::kable(digits = 2)

hed_frame_norm_trends$contrasts %>%
  knitr::kable(digits = c(NA,NA,2,2,2,2,3))
```

Confidence interval
```{r}
confint(hed_frame_norm_trends$contrasts) %>%
  knitr::kable(digits = 2)
```
...
```{r}
ing_norm_slopes <- emtrends(mod_mice, pairwise~norm_condition, var = "ingroup_center", adjust = "none")

ing_norm_slopes$emtrends %>%
  knitr::kable(digits = 2)

ing_norm_slopes$contrasts %>%
  knitr::kable(digits = c(NA,2,2,2,2,3)) # correct p-values
```

Confidence interval
```{r}
confint(ing_norm_slopes$contrasts) %>%
  knitr::kable(digits = 2)
```
...
### Ingroup x Norm x Framing

>> Exploratory RQ1: Is there a three-way interaction between ingroup identification, framing, and norm condition?

```{r}
ing_frame_norm_trends <- emtrends(mod_mice, pairwise~norm_condition | framing_condition, var = "ingroup_center", adjust = "none")

ing_frame_norm_trends$emtrends %>%
  knitr::kable(digits = 2)

ing_frame_norm_trends$contrasts %>%
  knitr::kable(digits = c(NA,NA,2,2,2,2,3))
```

Confidence interval
```{r}
confint(ing_frame_norm_trends$contrasts) %>%
  knitr::kable(digits = 2)
```
